...
namespace PoESkillTree.Engine.GameModel.PassiveTree.Options
{
    public class JsonPassiveTreeOptions
    {
        ...
        public Dictionary<CharacterClass, JsonCharacterAscendancyClassOption> CharacterAscendancyClasses { get; } = new Dictionary<CharacterClass, JsonCharacterAscendancyClassOption>();
        ...
        public Dictionary<JewelRadius, List<JsonJewelHighlight>> JewelHighlight { get; } = new Dictionary<JewelRadius, List<JsonJewelHighlight>>();
    }
}
