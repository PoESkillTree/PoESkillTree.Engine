...
namespace PoESkillTree.Engine.Computation.Parsing.SkillParsers
{
    ...
    public class SkillPreParser
    {
        ...
        private SkillPreParseResult Parse(Skill mainSkill, Skill parsedSkill, Entity entity)
        {
            ...
            var gemSource = new ModifierSource.Local.Gem(parsedSkill.ItemSlot, parsedSkill.SocketIndex, parsedSkill.SkillIndex, parsedSkill.GemGroup,
                mainSkill.Id, displayName);
