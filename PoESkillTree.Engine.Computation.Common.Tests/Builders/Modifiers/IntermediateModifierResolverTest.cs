...
namespace PoESkillTree.Engine.Computation.Common.Builders.Modifiers
{
    ...
    public class IntermediateModifierResolverTest
    {
        ...
        public void ResolveReturnsCorrectValueConverter()
        {
            ...
            resultMock.SetupGet(r => r.Entries).Returns(new IntermediateModifierEntry[0]);
        ...
        public void ResolveToReferencedBuilderThrowsIfNoEntries()
        {
            var result = Mock.Of<IIntermediateModifier>(r =>
                r.Entries == new IntermediateModifierEntry[0] &&
        ...
        private static readonly IReadOnlyList<IntermediateModifierEntry> DefaultEntries =
            Enumerable.Range(0, 3)
                .Select(_ => new IntermediateModifierEntry())
